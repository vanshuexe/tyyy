      ...
      <ScrollReveal>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-display font-medium text-[#0b1b36] tracking-tight mb-6">
            Connect With Our European Advisors
          </h2>
          <p className="text-base text-gray-500 font-light leading-relaxed">
            Submit your expansion requirements to schedule a strategic consultation with our jurisdiction directors.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 text-left">
                <div className="border-b border-gray-100 pb-3">
                  <h4 className="font-extrabold font-display uppercase tracking-tight text-lg text-[#15325b]">
                    Submit Expansion Brief
                  </h4>
                  <p className="text-xs text-gray-500">
                    Provide your commercial context for an accurate feasibility review.
                  </p>
                </div>
